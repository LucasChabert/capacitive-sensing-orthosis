...
ax1.grid(True)
fig1.tight_layout()
fig1.savefig("../figures/analysis/C1_inverse_vs_d.png", dpi=150)
print("Figure sauvegardée : figures/analysis/C1_inverse_vs_d.png")
...
ax2.grid(True)
fig2.tight_layout()
fig2.savefig("../figures/analysis/C2_inverse_vs_d.png", dpi=150)
print("Figure sauvegardée : figures/analysis/C2_inverse_vs_d.png")
...
ax3.grid(True)
fig3.tight_layout()
fig3.savefig("../figures/analysis/distance_calculee_vs_d.png", dpi=150)
print("Figure sauvegardée : figures/analysis/distance_calculee_vs_d.png")
