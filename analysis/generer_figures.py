...
fig.savefig("../figures/analysis/fig_C_vs_d.pdf"); plt.close(fig)
...
fig.savefig("../figures/analysis/fig_C1_fit.pdf"); plt.close(fig)
...
fig.savefig("../figures/analysis/fig_reconstruction.pdf"); plt.close(fig)
