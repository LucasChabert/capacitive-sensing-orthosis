...
#define FDC1004_CONF_MEAS_CHB_CAPDAC (0x4)  // CHB mode when CAPDAC is used
...
// Measurement bounds for CAPDAC adjustment
constexpr int32_t FDC1004_UPPER_BOUND = 0x4000;
constexpr int32_t FDC1004_LOWER_BOUND = -0x4000;
...
private:
     ...
     */
    bool autoAdjustCapdac(fdc1004_channel_t channel, int32_t raw_value);
};
