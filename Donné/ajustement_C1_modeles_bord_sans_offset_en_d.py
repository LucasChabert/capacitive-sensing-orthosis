...
Produit deux figures :
  - Figure/C1_parity_hysteresis.png  → graphe de parité (modèle vs mesure)
  - Figure/C1_model_vs_exp.png       → données expérimentales + courbes ajustées
"""
...
fig1.tight_layout()
fig1.savefig("Figure/C1_parity_hysteresis.png", dpi=150)
print("\nFigure sauvegardée : Figure/C1_parity_hysteresis.png")
...
fig2.tight_layout()
fig2.savefig("Figure/C1_model_vs_exp.png", dpi=150)
print("Figure sauvegardée : Figure/C1_model_vs_exp.png")
