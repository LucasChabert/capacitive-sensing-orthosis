...
C1_essai1 = df["C2 avec C1 pF"].to_numpy()
C1_essai2 = df["C2 avce C1 (2)"].to_numpy()
C1_essai3 = df["C2 avce C1 (3)"].to_numpy()
...
ax2.legend()         
fig2.tight_layout()
fig2.savefig("C1_fit_hysteresis.png", dpi=150)
# ==========================================================
# Figure 3 : Résidus
# ==========================================================
